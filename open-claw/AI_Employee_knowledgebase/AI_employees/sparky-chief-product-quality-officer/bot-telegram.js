...
bot.command("start", (ctx) => {
  ctx.reply("Chief Product and Quality Officer is online. Worker slug: " + slug + ". Agent route: " + agentId + ".");
});
...
bot.start();
console.log("Telegram bot is running for Chief Product and Quality Officer.");
