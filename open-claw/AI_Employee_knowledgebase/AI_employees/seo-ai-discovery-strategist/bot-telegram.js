...
bot.command("start", (ctx) => {
  ctx.reply("SEO and AI Discovery Strategist is online. Worker slug: " + slug + ". Agent route: " + agentId + ".");
});
...
bot.start();
console.log("Telegram bot is running for SEO and AI Discovery Strategist.");
