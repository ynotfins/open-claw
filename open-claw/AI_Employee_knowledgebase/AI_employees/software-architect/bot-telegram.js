...
const slug = "software-architect";

bot.command("start", (ctx) => {
  ctx.reply("Software Architect is online. Send a message to start working.");
});
...
bot.start();
console.log("Telegram bot is running for Software Architect.");
