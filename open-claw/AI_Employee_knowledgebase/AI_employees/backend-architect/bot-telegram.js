...
const slug = "BACKEND_BRUCE_BOT";
const agentId = process.env.OPENCLAW_AGENT_ID || slug;

bot.command("start", (ctx) => {
  ctx.reply("Backend Architect is online. Worker slug: " + slug + ". Agent route: " + agentId + ".");
});
...
bot.start();
console.log("Telegram bot is running for Backend Architect.");
